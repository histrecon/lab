// tags-info.js - Модальное окно с расшифровкой эпох
...
(function() {
    ...
    <div class="tags-modal-overlay" id="tagsModal">
        <div class="tags-modal-content">
            ...
            <div class="tags-modal-header">
                ...
                <h2 class="tags-modal-title">Расшифровка эпох</h2>
                <p class="tags-modal-subtitle">Подробное описание всех исторических эпох, используемых в базе</p>
            </div>
            ...
            <div class="tags-modal-body">
                <ul class="tags-list">
					...
					<li class="tags-item">
                        <div class="tag-name">Хеттское царство</div>
                        <div class="tag-description">Период в исторической реконструкции, специализирующийся на истории, культуре и военном деле Хеттского царства — могущественной древней державы в Малой Азии (XVII-XII вв. до н.э.). Включает реконструкцию хеттского вооружения, доспехов, колесниц, а также быта.</div>
                    </li>
                    <li class="tags-item">
                        <div class="tag-name">Древний Рим</div>
                        <div class="tag-description">Период в исторической реконструкции, специализирующийся на истории, легионах, быте и культуре Древнего Рима, а так же других народах, контактировавших с Римом в данный период. Включает период Римской республики и Римской империи (примерно с 753 г. до н.э. по 476 г. н.э.).</div>
                    </li>
                    <li class="tags-item">
                    ...
                    <li class="tags-item">
					<li class="tags-item">
                        <div class="tag-name">Наполеоника</div>
                        <div class="tag-description">Период в исторической реконструкции, специализирующийся на истории, униформе, вооружении и сражениях эпохи Наполеоновских войн (1799-1815 гг.). Включает реконструкцию армий Франции, России, Великобритании, Австрии, Пруссии и других стран-участниц, а также быт, артиллерию и кавалерию той эпохи.</div>
                    </li>
					<li class="tags-item">
                        <div class="tag-name">ACW (Гражданская война в США)</div>
                        <div class="tag-description">Период в исторической реконструкции, специализирующийся на истории, униформе, вооружении и сражениях Гражданской войны в США (1861-1865 гг.). Включает реконструкцию армий Союза и Конфедерации, пехоты, кавалерии, артиллерии, а также быт и жизнь американского общества того времени. ACW — от англ. American Civil War.</div>
                    </li>
					<li class="tags-item">
                    ...
                    <li class="tags-item">
                        <div class="tag-name">СБ (Средневековый Бой)</div>
                        <div class="tag-description">Направление, занимающееся полноконтактными боями с использованием средневекового оружия и доспехов. СБ включает в себя различные форматы боевых столкновений, не обязательно соответствующие официальным спортивным регламентам и федерациям.
					</li>
                    <li class="tags-item">
                    ...
                    <li class="tags-item">
                        <div class="tag-name">Ролевка</div>
                        <div class="tag-description">Дополнительное направление, объединяющее ролевые игры живого действия (РИЖД), фэнтези-реконструкцию, косплей и другие формы погружения в вымышленные миры. Сюда относятся как исторические ролевые игры, так и игры по мотивам литературных произведений, киновселенных и фэнтези-сеттингов. Ролевка часто пересекается с исторической реконструкцией, но имеет более свободный подход к исторической достоверности.</div>
					</li>
                </ul>
            </div>
    ...
    function initTagsModal() {
        ...
        if (!tagsInfoButton) {
            console.warn('Кнопка "Расшифровка эпох" не найдена на странице');
            return;
        }

        if (!tagsModal) {
            console.error('Модальное окно для расшифровки эпох не найдено на странице');
            return;
        }
        ...
        console.log('✅ Модальное окно "Расшифровка эпох" инициализировано');
    ...
    function loadTagsModal() {
        if (document.getElementById('tagsModal')) {
            console.log('Модальное окно эпох уже загружено на странице');
            initTagsModal();
            return;
        }
    ...
    function ensureTagsButton() {
        ...
        console.log('Кнопка "Расшифровка эпох" создана автоматически');
    }
